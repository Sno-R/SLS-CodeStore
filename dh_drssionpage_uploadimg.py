...
page.ele('#user').input('admin590889-01')   # 输入账号
page.ele('#pwd').input('Aw_590889-01')  # 输入密码
...
page.ele('@placeholder=多个逗号分隔').input('240905-556101803551871')   # 输入框填写
...
# # page.ele('@placeholder=请填写售后内容').input()
...
# select.select.by_value('发错材质[收货10天内申请 ]')

# page.ele('@class=btn btn-hpi pull-left').click.to_upload(r':/Users\Admintrator\Desktop/影刀运行文件/PixPin_2024-09-05_10-38-51.png')    # 上传多文件用列表
